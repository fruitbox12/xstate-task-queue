  ...
  createMachine(
    {
      ...
      tsTypes: {} as import("./thread.typegen").Typegen0,

      states: {
        "Waiting for resources to be available": {
          after: {
            "1000": "Getting context of the thread",
          },
        },

        "Getting context of the thread": {
          after: {
